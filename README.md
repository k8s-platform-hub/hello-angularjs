...
This project consists of a basic Hasura project with a simple AngularJS app running on it. Once this app is deployed on a Hasura cluster, you will have the app running at `https://www.<cluster-name>.hasura-app.io`

This is the right place to start if you are planning to build or want to learn to build an AngularJS app with Hasura.

## Sections

* [Introduction](#introduction)
* [Quickstart](#quickstart)
* [Adding your own AngularJS code](#adding-your-existing-angularjs-code)
* [Data API](#data-apis)
* [Auth API](#auth-apis)
...
```sh
$ hasura quickstart hello-angularjs
$ cd hello-angularjs
```

The above command does the following:
1. Creates a new folder in the current working directory called `hello-angularjs`
2. Creates a new free Hasura cluster for you and sets that cluster as the default cluster for this project
3. Initializes `hello-angularjs` as a git repository and adds the necessary git remotes.
...
## Adding your existing angularjs code
...
```
$ git add .
$ git commit -m "Added my angularJS code"
```
...
This quickstart comes with one such custom service made using AngularJS. Check it out in action at `https://www.cluster-name.hasura-app.io` . Currently, it just returns a welcome message at that endpoint.
...
$ docker build -t angularjs:<tag> .
$ docker run -d -p 8080:8080 angularjs:<tag>
```
